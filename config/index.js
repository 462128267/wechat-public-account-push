export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxdda9018aa930462d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "4b7339078101320eb50f90c66747ec03",
  ...
  USERS: ["orUlF6nPJ-vbxP2yLdY351RzfzU8,orUlF6sqwxPU0tI3pO9hD0Zs7fLI"]
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "谭理雪", "year": "2004", "date": "7-24"},
  ...
  CALLBACK_TEMPLATE_ID: "	MrAr1aJEayBVB_ctHBT6pnH24nW5_8yIdBCEzi3boH0",

  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: ["orUlF6nPJ-vbxP2yLdY351RzfzU8"]
    {
      // 一般都填自己orUlF6nPJ-vbxP2yLdY351RzfzU8
      name: "自己",
